<template>
  <div class="bg-gray-50">
    <MyHeader />
    <MyHero title="We Are" title-high="MUXEE" content="A passionate team of innovators dedicated to transforming businesses through cutting-edge digital solutions and creative excellence." />
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                <div class="animate-fadeInUp">
                    ...
                    <p class="text-gray-600 mb-4">
                        Founded in 2016, MUXEE began as a small team of passionate developers and designers with a shared vision: to create digital experiences that make a difference.
                    </p>
                    <p class="text-gray-600 mb-4">
                ...
                <div class="relative">
                    ...
                    <div class="absolute -bottom-3 -right-3 bg-white p-6 rounded-xl shadow-lg max-w-xs">
    ...
    <section class="py-20">
        <div class="container mx-auto px-4">
            <div class="text-center mb-16">
                ...
                <p class="text-xl text-gray-600 max-w-3xl mx-auto">
                    The talented individuals behind MUXEE's success
                </p>
            </div>
